window.App=(function(){
  ...
  function render(){renderNav();routes[route].render(data());}
  function fab(){if(route==='finance')FinanceUI.newTransactionForm();else if(route==='debts')DebtUI.newDebtForm();else if(route==='tasks')TasksUI.newTaskForm();else FinanceUI.newTransactionForm();}
