window.UXRefinements=(function(){
  ...
  function defaultWalletId(data){return (data.preferences&&data.preferences.defaultWalletId)||((data.wallets||[])[0]||{}).id||'wallet_main';}
  ...
  function showFinance(data){
    ...
    Dom.setHeader('Finanças','Transações, contas financeiras, contas pendentes, cartões e relatórios.');
