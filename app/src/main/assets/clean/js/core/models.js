window.Models=(function(){
  ...
  function wallet(data){const input=data||{};const real=input.realBalance!==undefined?input.realBalance:(input.initialBalance!==undefined?input.initialBalance:0);return Object.assign({id:'wallet_main',name:'Principal',type:'corrente',realBalance:real,initialBalance:real,includeInTotal:true},input,{realBalance:real,initialBalance:real});}
